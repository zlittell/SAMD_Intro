...
void configureClocks(void)
{
    ...
    //__pm_init())
    PM->CPUSEL.reg = PM_CPUSEL_CPUDIV(PM_CPUSEL_CPUDIV_DIV1_Val);
    PM->APBASEL.reg = PM_APBASEL_APBADIV(PM_APBASEL_APBADIV_DIV1_Val);
    PM->APBBSEL.reg = PM_APBBSEL_APBBDIV(PM_APBBSEL_APBBDIV_DIV1_Val);
